...
describe('gold-preview.fig clipboard roundtrip', () => {
  ...
  it('OpenWeave format: zero property differences', () => {
    const html = buildOpenWeaveClipboardHTML(topLevelNodes, graph)
  ...
  it('OpenWeave format: compressed data is under 1MB', () => {
    const html = buildOpenWeaveClipboardHTML(topLevelNodes, graph)
