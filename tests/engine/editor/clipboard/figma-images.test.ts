...
import { buildFigmaClipboardHTML } from '@openweave/core/clipboard'
import { createEditor } from '@openweave/core/editor'
import type { ClipboardImageResolution } from '@openweave/core/editor'
...
describe('Figma clipboard images', () => {
  ...
  test('resolves and stores missing images before completing paste', async () => {
    ...
    expect(calls).toEqual([{ fileKey: 'openweave', hashes: [IMAGE_HASH_A] }])
