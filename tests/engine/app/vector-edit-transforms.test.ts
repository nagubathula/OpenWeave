...
import { createEditor, type Editor } from '@openweave/core/editor'
import { regenerateFillGeometry } from '@openweave/core/vector'
import { SceneGraph } from '@openweave/scene-graph'
import type { SceneNode, VectorNetwork } from '@openweave/scene-graph'
