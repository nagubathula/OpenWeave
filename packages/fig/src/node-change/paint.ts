import type { Paint, Effect as KiwiEffect } from '@openweave/kiwi/fig/codec'
...
import { BLACK } from '@openweave/scene-graph/constants'
import type { Color, Matrix } from '@openweave/scene-graph/primitives'
