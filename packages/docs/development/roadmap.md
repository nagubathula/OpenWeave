...
7. **Slot workflows and nested-instance property surfacing** — component property authoring is complete; slots and Figma's "expose properties from nested instances" remain.
