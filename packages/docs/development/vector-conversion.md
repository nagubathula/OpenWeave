...
description: Development notes for OpenWeave boolean operations, flattening, text outlines, stroke outlines, and vector geometry conversion.
---

# Vector conversion

OpenWeave has a shared path-conversion pipeline for commands that turn scene nodes into vector geometry.
