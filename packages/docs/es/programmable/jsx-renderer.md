...
```sh
openweave export design.fig -f jsx                   # formato OpenWeave
openweave export design.fig -f jsx --style tailwind  # clases Tailwind
```
