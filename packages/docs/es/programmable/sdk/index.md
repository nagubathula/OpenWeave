---
title: React SDK
description: Construye editores con OpenWeave usando composables headless y primitivos de Vue.
---

# React SDK

`@openweave/react` existe para que OpenWeave pueda ser más que una aplicación de diseño independiente.

El objetivo es convertir OpenWeave en un toolkit que puedas integrar en otros productos, herramientas internas y editores específicos de flujo de trabajo — no solo una interfaz predeterminada.

La aplicación OpenWeave es una composición de ese toolkit. El SDK es la forma en que construyes una diferente.
...
- **Integración con el framework**: integración de Vue sobre `@openweave/core`
