...
graph TB
    subgraph Tauri["Tauri v2 Shell"]
        subgraph Editor["Editor (Web)"]
            UI["React UI<br/>Toolbar · Panels · Properties<br/>Layers · Color Picker"]
...
Yoga de Meta proporciona cálculo de layout CSS flexbox y grid a través de un [fork](https://github.com/openweave/yoga/tree/grid) con soporte CSS Grid. Un adaptador delgado mapea nombres de propiedades de Figma a equivalentes de Yoga:
