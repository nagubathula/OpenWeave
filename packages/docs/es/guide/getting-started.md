...
OpenWeave funciona en el navegador — sin instalación. Abre [app.openweave.dev](https://app.openweave.dev).

## Descargar la aplicación de escritorio

Binarios para macOS, Windows y Linux en la [página de releases](https://github.com/openweave/openweave/releases/latest).
