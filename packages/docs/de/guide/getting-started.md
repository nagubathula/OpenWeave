...
OpenWeave läuft im Browser — keine Installation nötig. Öffne [app.openweave.dev](https://app.openweave.dev) um loszulegen.

## Desktop-App herunterladen

Vorgefertigte Binärdateien für macOS, Windows und Linux sind auf der [Releases-Seite](https://github.com/openweave/openweave/releases/latest) verfügbar.
