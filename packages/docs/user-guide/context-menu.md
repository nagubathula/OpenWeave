---
title: Context Menu
description: Right-click context menu actions in OpenWeave — clipboard, z-order, grouping, components, and more.
---
...
- **Copy as JSX** — copies the OpenWeave JSX representation for use with `renderJsx()`
