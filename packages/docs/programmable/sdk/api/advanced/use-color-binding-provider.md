...
description: OpenWeave COLOR variable provider for BindableValue fields.
---

# useColorBindingProvider

`useColorBindingProvider()` adapts OpenWeave COLOR variables to the generic `BindingProvider<Color>`
