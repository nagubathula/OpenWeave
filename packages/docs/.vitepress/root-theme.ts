...
export const rootThemeConfig = (): DefaultTheme.Config => ({
  ...
  nav: [
    ...
    { text: 'Open App', link: 'https://app.openweave.dev' },
  ],
  ...
  socialLinks: [{ icon: 'github', link: 'https://github.com/openweave/openweave' }],

  editLink: {
    pattern: 'https://github.com/openweave/openweave/edit/main/packages/docs/:path',
  },
