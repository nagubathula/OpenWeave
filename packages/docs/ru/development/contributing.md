...
```
packages/
  core/              @openweave/core — движок (без DOM-зависимостей)
    src/             Граф сцены, отрисовщик, компоновка, кодек, kiwi, типы
  cli/               @openweave/cli — headless CLI для операций с .fig
