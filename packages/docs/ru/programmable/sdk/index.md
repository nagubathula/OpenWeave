---
title: React SDK
description: Создавайте редакторы на базе OpenWeave с помощью headless-хуков и примитивов для React.
---
...
- **Интеграция с фреймворком**: React-интеграция поверх `@openweave/core`
