...
description: Справочная документация по компонентам, компосаблам и расширенным API @openweave/react.
---
...
<SdkCardGroup>
  ...
  <SdkCard title="Компосаблы" to="/programmable/sdk/api/hooks/" description="Компосаблы для контекста редактора, подключения холста, выделения, команд и панелей свойств." />
