...
description: Структура папок, границы публичного API и паттерны компоновки в @openweave/react.
---

# Архитектура SDK

`@openweave/react` — React-слой поверх `@openweave/core`.
...
Если кусок логики можно переиспользовать в другом приложении на базе OpenWeave без привнесения стилей — скорее всего, ему место в `@openweave/react`.
