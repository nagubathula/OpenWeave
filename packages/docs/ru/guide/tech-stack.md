...
| **UI-фреймворк** | Vue 3 + React Hooks | Реактивный Composition API, отличная поддержка TypeScript |
...
Проект мигрировал с Vue 3 на React/Next.js на ранней стадии разработки. Система реактивности Vue и композаблы React Hooks оказались более эргономичными для управления состоянием редактора.
...
|-----------|---------|-------|
| CSS Grid в Yoga | Макет на основе сетки | ✅ Включено через [форк Yoga](https://github.com/openweave/yoga/tree/grid) (`@openweave/yoga-layout`) |
