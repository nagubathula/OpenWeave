...
description: Skonfiguruj @openweave/vue z createEditor, provideEditor i kanwasem.
---
...
SDK mieszka dziś w monorepo i jest również publikowany jako `@openweave/vue`.
...
2. `@openweave/vue` — kompozyty Vue i bezstanowe prymitywy
