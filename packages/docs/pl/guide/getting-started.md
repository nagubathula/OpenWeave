...
OpenWeave działa w przeglądarce — bez instalacji. Otwórz [app.openweave.dev](https://app.openweave.dev).

## Pobierz aplikację desktopową

Binaria dla macOS, Windows i Linux na [stronie wydań](https://github.com/openweave/openweave/releases/latest).
