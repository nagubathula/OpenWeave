...
OpenWeave fonctionne dans le navigateur — aucune installation requise. Ouvrez [app.openweave.dev](https://app.openweave.dev).

## Télécharger l'application de bureau

Binaires pour macOS, Windows et Linux sur la [page des versions](https://github.com/openweave/openweave/releases/latest).
