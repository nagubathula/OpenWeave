...
OpenWeave funziona nel browser — nessuna installazione richiesta. Apri [app.openweave.dev](https://app.openweave.dev) per iniziare a progettare.

## Scarica l'app desktop

Binari precompilati per macOS, Windows e Linux sono disponibili nella [pagina dei rilasci](https://github.com/openweave/openweave/releases/latest).
