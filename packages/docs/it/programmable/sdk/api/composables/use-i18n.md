---
title: useI18n
description: Leggi i messaggi UI OpenWeave localizzati e cambia la lingua attiva dell'SDK.
---

# useI18n

`useI18n()` restituisce gruppi di traduzione reattivi e controlli della lingua per le shell editor basate su OpenWeave.
...
```ts
import { useI18n } from '@openweave/vue'
