...
export const dialogMessageDefaults = {
  ...
  vectorizeSaveKey: 'Save key',
  vectorizeClearKey: 'Clear',
  vectorizeGetAPIKey: 'Get API key',
  ...
  share: 'Share',
  appUpToDate: 'OpenWeave is up to date',
  updateAvailableTitle: 'Update OpenWeave',
  updateAvailable: params('OpenWeave {version} is available.'),
  updateInstallPrompt:
    'Download and install it now? The app will restart after the update is installed.',
  downloadingUpdate: params('Downloading OpenWeave {version}'),
  ...
  shareViaNgrok: 'Share via ngrok',
  ngrokHint: 'Temporary public link for this room — no domain or hosting needed.',
  ngrokStarting: 'Starting ngrok tunnel…',
  ngrokPublicLink: 'Public link (ngrok)',
  ngrokStopTunnel: 'Stop tunnel',
  ngrokFailed: params('ngrok failed: {error}'),
  ngrokSetupHint:
    'Install ngrok and sign in with "ngrok config add-authtoken <token>" to use free temporary URLs.',
