...
export const panelMessageDefaults = {
  ...
  maskIsOutline: 'Use outline as mask',
  ...
  createStringVariable: params('Create text variable from {value}'),
  content: 'Content',
  ...
  prototypeAddInteraction: 'Add interaction',
  prototypeRemoveInteraction: 'Remove interaction',
  prototypeTrigger: 'Trigger',
  prototypeAction: 'Action',
  prototypeDestination: 'Destination',
  prototypeTransition: 'Animation',
  prototypeDuration: 'Duration',
  prototypeDelay: 'Delay',
  prototypeUrl: 'URL',
  prototypeOnClick: 'On click',
  ...
  prototypeTransitionDissolve: 'Dissolve',
  prototypeTransitionSlideLeft: 'Slide from left',
  prototypeTransitionSlideRight: 'Slide from right',
  prototypeTransitionSlideTop: 'Slide from top',
  prototypeTransitionSlideBottom: 'Slide from bottom',
  prototypeNone: 'None',
  prototypePresent: 'Present',
  prototypeRestart: 'Restart',
  prototypeClose: 'Close',
  prototypeFlowStart: 'Flow starting point',
  prototypeSetFlowStart: 'Set as starting point',
  prototypeClearFlowStart: 'Remove starting point',
  prototypeNoDestination: 'Add a destination frame to connect this layer',
  prototypeEmptyHint: 'Select a layer on the canvas to add an interaction',
