import React, { useRef, useState, useCallback, useImperativeHandle, forwardRef, type ReactNode } from 'react'
...
export const GradientEditorBar = forwardRef<HTMLDivElement, GradientEditorBarProps>(({
  ...
  const stopPointerDown = useCallback((index: number, e: React.PointerEvent) => {
    onSelectStop?.(index)
