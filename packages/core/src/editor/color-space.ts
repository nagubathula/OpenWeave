import type { DocumentColorSpace, SceneNode } from '@openweave/scene-graph'
import { copyEffects, copyFill, copyStyleRuns, copyStroke } from '@openweave/scene-graph/copy'
