...
import { ALL_TOOLS, CODEGEN_PROMPT } from '@openweave/core/tools'
...
const automationTargetSchema = {
  document_id: z.string().describe('Optional OpenWeave document/tab ID to target').optional(),
...
export function registerTools(mcpServer: McpServer, options: RegisterToolsOptions) {
  ...
  register(
    ...
    {
      description:
        'List open OpenWeave documents/tabs with their IDs, file paths, current pages, and pages.',
