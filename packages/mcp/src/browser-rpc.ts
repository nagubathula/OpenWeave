...
const APP_NOT_CONNECTED_MESSAGE =
  'OpenWeave app is not connected. STOP and tell the user: "The OpenWeave desktop app is not running, no document is open, or the desktop app is connected to a different MCP server. Please start OpenWeave, open a document, and try again." Do NOT attempt to start the app yourself or retry automatically.'
