...
import type { AnalyzeOverlapsResult } from '@openweave/core/rpc'
import {
...
export default defineCommand({
  ...
  args: {
    ...
    'document-id': {
      type: 'string',
      description: 'Target OpenWeave document/tab ID when connected to the running app',
      required: false
    },
    type: {
      type: 'string',
