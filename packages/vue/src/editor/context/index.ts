...
/**
 * Injection key for the current OpenWeave editor instance.
 *
 * Most SDK consumers should use {@link provideEditor} and {@link useEditor}
 * instead of interacting with this symbol directly.
 */
export const EDITOR_KEY: InjectionKey<Editor> = Symbol('openweave-editor')

/**
 * Provides an OpenWeave editor instance to the current Vue subtree.
 *
