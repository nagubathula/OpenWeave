...
const numberFieldTheme = {
  slots: {
    ...
    leading:
      'flex shrink-0 cursor-ew-resize items-center justify-center self-stretch px-[5px] text-muted hover:text-surface transition-colors select-none [&>*]:pointer-events-none',
    field:
      'min-w-0 flex-1 cursor-text border-none bg-transparent pr-1.5 font-[inherit] text-[11px] text-surface outline-none',
    display:
      'flex flex-1 cursor-text items-center truncate overflow-hidden text-[11px] select-none',
