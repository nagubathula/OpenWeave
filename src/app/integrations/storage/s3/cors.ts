...
/** Origins OpenWeave may run from when calling S3 from the browser. */
export const CLOUD_CORS_STATIC_ORIGINS = [
  ...
  WEB_APP_ORIGIN,
  // Wildcards: any openweave.dev subdomain (staging, demo, …), Cloudflare
